...
The output has one single file mimicing a fasta format:
...
The fam_name:group_number is the CAZyme family or EC number assigned by CAMI by comparing the query protein against the k-mer peptide library of CAZymes or ECs (fam_name is the CAZyme or EC cluster from the library, and group_number is the count of proteins in that CAZyme or EC cluster). 
